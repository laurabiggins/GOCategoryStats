...
#ggplot(genfo, aes(x = occurrences, y = log2(length))) +
#  geom_point(size = 0.6)
...
#genfo %>%
#  subset(occurrences > 10) %>%
#  ggplot() + geom_point(aes(x = occurrences, y = log2(length), color = get_density(occurrences, log2(length), n = 50)))
