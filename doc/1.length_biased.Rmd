...
```{r check_results}
ifelse(using_laptop,
       load("C:/Users/bigginsl/Desktop/temp//GOcategoryStats/data/length_results.rda"),
       load("M:/GOcategoryStats/data/length_results.rda")
)
...
```{r beanplot_filtered, fig.width = 10, eval = FALSE}
filtered_categories <- lapply(ordered_categories, function(x) x[x >= 10])
