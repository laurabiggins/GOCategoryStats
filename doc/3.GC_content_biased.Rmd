...
Originally, I selected arbitrary thresholds of 0.35, 0.4, 0.5, 0.55, 0.6 GC. 
These seemed like reasonable numbers to choose.
...
I'll select GC content thresholds based on the distribution of GC content over all genes.
The probabilities I'm using are 0.01, 0.05, 0.1, 0.9, 0.95, 0.99.
```{r}
